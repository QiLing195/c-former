...
| 能力 | 指标 | 报告 |
|---|---|---|
| 身份解析（混合架构：精确层+神经层，273 对象） | name/alias 精确命中 **100%**；神经层 heldout **99%**（变体增强后"学会表达方式"） | [`V62_OBSERVER_REPORT.md`](V62_OBSERVER_REPORT.md) |
| 理解层（QueryUnderstanding） | 33 条盲测（改写/网页语境/库外对象）**100%**；库外版本越界拦截（GPT-6→unknown） | [`V63_RECURSION_REPORT.md`](V63_RECURSION_REPORT.md) |

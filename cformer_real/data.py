...
class AIModelWorld:
    ...
    def _by_kind(self, kind: str, split: str | None) -> list[dict]:
    ...
    def known_queries(self, split: str | None = None) -> list[dict]:
        return self._by_kind("known", split)

    def ambiguous_queries(self, split: str | None = None) -> list[dict]:
        return self._by_kind("ambiguous", split)

    def unknown_queries(self, split: str | None = None) -> list[dict]:
        return self._by_kind("unknown", split)

...
SERIES = [
    ("OpenAI", "美国", False, "GPT", [
        ...
        _entry("GPT-5.1", "2025"),
        _entry("GPT-5.2", "2026", "当前前沿闭源旗舰", REVIEW),
    ]),
    ...
    ("Anthropic", "美国", False, "Claude", [
        ...
        _entry("Claude Sonnet 4.5", "2025", "均衡", REVIEW),
        _entry("Claude Haiku 4.5", "2025", "轻量", REVIEW),
        _entry("Claude Opus 4.5", "2025", "旗舰"),
        _entry("Claude Opus 4.7", "2026", "旗舰", REVIEW),
        _entry("Claude Opus 4.8", "2026", "SWE-bench 领先", REVIEW),
    ]),
    ("Google", "美国", False, "Gemini", [
        ...
        _entry("Gemini 3.5 Pro", "2026", "代理编码旗舰", REVIEW),
        _entry("Gemini 3.5 Flash", "2026", "最快代理编码", REVIEW),
    ]),
    ...
    ("Mistral AI", "法国", True, "Mistral", [
        ...
        _entry("Mistral Large 3", "2025", "旗舰", REVIEW),
    ]),
    ("阿里巴巴", "中国", True, "Qwen", [
        _entry("Qwen 1", "2023"), _entry("Qwen 1.5", "2024"),
        _entry("Qwen2", "2024"),
        _entry("Qwen-VL", "2024", "多模态", REVIEW),
        ...
        _entry("Qwen3.5", "2025", "开源旗舰", REVIEW),
        _entry("Qwen3.6", "2026", "开源旗舰", REVIEW),
        _entry("Qwen3.7-Max", "2026", "闭源国产旗舰第一", REVIEW),
    ]),
    ("深度求索", "中国", True, "DeepSeek", [
        _entry("DeepSeek-V1", "2024", "", REVIEW),
        ...
        _entry("DeepSeek-V4", "2026", "开源旗舰", REVIEW),
        _entry("DeepSeek-V4-Pro", "2026", "开源旗舰", REVIEW),
    ]),
    ("月之暗面", "中国", True, "Kimi", [
        _entry("Kimi K1", "2024", "", REVIEW), _entry("Kimi K1.5", "2025", "推理"),
        _entry("Kimi K2", "2025", "开源"),
        _entry("Kimi K2 Thinking", "2025", "推理", REVIEW),
        _entry("Kimi K2.5", "2025", "开源旗舰", REVIEW),
        _entry("Kimi-K2.6", "2026", "开源旗舰", REVIEW),
    ]),
    ("智谱AI", "中国", True, "GLM", [
        _entry("GLM-4", "2024"),
        _entry("GLM-4.5", "2025"), _entry("GLM-4.5-Air", "2025", "轻量开源"),
        _entry("GLM-Z1", "2025", "推理"), _entry("GLM-4.6", "2025"),
        _entry("GLM-5", "2025", "", REVIEW),
        _entry("GLM-5.1", "2026", "开源", REVIEW),
        _entry("GLM-5.3", "2026", "开源编程最强", REVIEW),
    ]),
    ("MiniMax", "中国", True, "MiniMax", [
        _entry("MiniMax Text-01", "2025", "长上下文"),
        _entry("MiniMax M1", "2025", "推理MoE"), _entry("MiniMax M2", "2025", "开源"),
        _entry("MiniMax M2.5", "2025", "开源", REVIEW),
        _entry("MiniMax M2.7", "2026", "开源", REVIEW),
    ]),
    ("字节跳动", "中国", False, "豆包", [
        _entry("豆包 1.0", "2023"), _entry("豆包 1.5", "2025", "商用"),
        _entry("豆包 1.5 Pro", "2026", "推理突出", REVIEW),
        _entry("豆包 1.6", "2025", "商用旗舰", REVIEW),
    ]),
    ("字节跳动", "中国", False, "Seed", [
        _entry("Seed 1.5", "2025", "多模态", REVIEW),
        _entry("Seed 2.0", "2025", "多模态", REVIEW),
    ]),
    ("腾讯", "中国", False, "混元", [
    ...
    ("阶跃星辰", "中国", True, "Step", [
        _entry("Step-1", "2024", "", REVIEW), _entry("Step-1V", "2024", "多模态"),
        _entry("Step-2", "2024", "", REVIEW), _entry("Step-3", "2025", "", REVIEW),
    ]),
    ("零一万物", "中国", True, "Yi", [
    ...
    ("昆仑万维", "中国", True, "Skywork", [
        ...
        _entry("Skywork 4.0", "2024", "开源", REVIEW),
    ]),
    ("科大讯飞", "中国", False, "星火", [
    ...
    ("华为", "中国", False, "盘古", [
        _entry("盘古 5.0", "2024", "行业多模态", REVIEW),
    ]),
    ("微软", "美国", True, "Phi", [
...
def build():
    ...
    queries.extend([
        ...
        {"text": "OpenAI 最新发布的旗舰模型是哪一个？", "target_id": "gpt-5-2", "kind": "known"},
        {"text": "谷歌推出的代理编码旗舰模型叫什么？", "target_id": "gemini-3-5-pro", "kind": "known"},
    ...
    queries.extend([
        ...
        {"text": "Claude Opus 5 的最新版本是什么？", "target_id": None, "kind": "unknown"},
